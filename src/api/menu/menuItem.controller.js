...
router.get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const menuItems = yield prisma_1.prisma.menuCategory.findMany({
            orderBy: {
                id: 'asc'
            },
            include: {
...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const category = yield prisma_1.prisma.menu.create({
            data: {
...
router.put('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const { name, price, menuCategoryId } = req.body;
        const category = yield prisma_1.prisma.menu.update({
            where: {
                id: Number(id)
            },
            data: {
